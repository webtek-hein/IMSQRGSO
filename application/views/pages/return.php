                    ...
                    <div class="x_content" style="overflow-x:auto;">
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td>$320,800</td>
                                <td>
                                    <a href="#" data-toggle="modal" data-target=".replace" class="btn btn-info btn-xs"><i class="fa fa-refresh"></i> Replace</a>
                                    <a data-toggle="modal" data-target=".ignore" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Ignore</a>
                                </td>
                            </tr>
                            <tr>
