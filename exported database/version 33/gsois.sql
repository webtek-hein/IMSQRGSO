...
INSERT INTO `distribution` (`dist_id`, `date_received`, `quantity_distributed`, `PR_no`, `OBR_no`, `item_det_id`, `ac_id`, `supply_officer_id`, `user_id`, `dept_id`, `status`, `cost`, `remarks`) VALUES
(1, '2018-03-28', 5, '1', '12314', 1, 1, 1, 8, 11, 'Accepted', 45000, ''),
(2, '2018-03-28', 10, '2', '24121', 2, 1, 1, 8, 11, 'Accepted', 400, ''),
(3, '2018-03-28', 10, '1', '12312', 2, 1, 1, 8, 12, 'pending', 400, ''),
(4, '2018-03-28', 10, '3', '21415', 2, 1, 1, 8, 11, 'Accepted', 400, '');
...
INSERT INTO `item` (`item_id`, `quantity`, `cost`, `unit`, `item_name`, `item_description`, `item_type`, `serialStatus`, `initialStock`, `initialCost`) VALUES
(1, 15, 45000, 'piece', 'Laptop', 'HP Elite Core i5 4gb Mem QUADCORE Business Gaming Laptop COD', 'CO', '1', 10, 45000),
(2, 170, 400, 'ream', 'Coupon Bond', 'Long, Cactus', 'MOOE', '0', 200, 400);
...
INSERT INTO `itemdetail` (`item_det_id`, `date_delivered`, `date_received`, `quantity`, `unit_cost`, `expiration_date`, `OR_no`, `PO_number`, `status`, `item_id`, `supplier_id`) VALUES
(1, '2018-03-28', '2018-03-28', 5, 45000, '2025-03-28', '#1B885697', '12312', 'active', 1, 1),
(2, '2018-03-28', '2018-03-28', 170, 400, '2023-03-28', 'I1fIi245', '1231412', 'active', 2, 2),
(3, '2018-03-29', '2018-03-29', 10, 45000, '2025-03-29', '#1B885698', '12312', 'active', 1, 1);
...
(1, 'VaDjfQ8U', NULL, 'Distributed', '1', 1, 1),
(2, 'Cn53GrFb', NULL, 'Distributed', '1', 1, 1),
(3, 'uhCe4EHe', NULL, 'Distributed', '1', 1, 1),
(4, 'AgNdseYS', NULL, 'Distributed', '1', 1, 1),
(5, 'G29uNMJy', NULL, 'Distributed', '1', 1, 1),
(6, 'HgPQJ8Xx', NULL, 'In-stock', '1', NULL, 1),
(7, 'qkKKan8t', NULL, 'In-stock', '1', NULL, 1),
(8, 'J39BuT6s', NULL, 'In-stock', '1', NULL, 1),
(9, '3YtaTyXH', NULL, 'In-stock', '1', NULL, 1),
(10, 'xv4FDyt9', NULL, 'In-stock', '1', NULL, 1),
...
INSERT INTO `transaction` (`trans_id`, `date`, `transaction_number`, `increased`, `decreased`, `unit_cost`, `item_id`, `transaction`) VALUES
(1, '2018-03-28', '#1B885697', 10, NULL, 45000, 1, 'added'),
(2, '2018-03-28', '1', NULL, 5, 45000, 1, 'issued'),
(3, '2018-03-28', 'I1fIi245', 200, NULL, 400, 2, 'added'),
(4, '2018-03-28', '2', NULL, 10, 400, 2, 'issued'),
(5, '2018-03-28', '1', NULL, 10, 400, 2, 'issued'),
(6, '2018-03-28', '3', NULL, 10, 400, 2, 'issued'),
(7, '2018-03-29', '#1B885698', 10, NULL, 45000, 1, 'added');
...
--
ALTER TABLE `serial`
  MODIFY `serial_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
