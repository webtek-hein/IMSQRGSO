...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2018 at 05:22 AM
...
CREATE TABLE `serial` (
  ...
  `item_status` enum('In-stock','Distributed','Returned','Accepted','UserDistributed') NOT NULL DEFAULT 'In-stock',
...
(10, 'test1', 'test1', 'test2@gmail.com', '09998523651', 'test1', '$2y$12$yQJ.q3SZsVpV4idEtTZFYeg9gjCQ89p6S7NXe7JTuwmmC.nYwk5.a', 'Supply Officer', 'Active', 12);
