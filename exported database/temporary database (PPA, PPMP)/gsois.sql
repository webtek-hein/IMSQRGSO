...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2018 at 01:16 PM
...
--
ALTER TABLE `ppa`
  MODIFY `ppa_id` int(15) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `ppmp`
--
ALTER TABLE `ppmp`
  MODIFY `ppmp_id` int(15) NOT NULL AUTO_INCREMENT;
--
